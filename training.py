...
from model import WhittleRNN, ProNeW, ProNeWEM
from model.n_beats import NBeatsPredictor
from model.cwspn import CWSPN, CWSPNConfig
from model.weinsum import WEinsum, WEinsumConfig
from model.spectral_rnn import SpectralRNN, SpectralRNNConfig
from model.weinsum.EinsumNetwork.ExponentialFamilyArray import NormalArray, MultivariateNormalArray
...
experiments = [
    (ReadPowerPKL(), ZScoreNormalization((0,), 3, 2, [True, True, True, False], min_group_size=0,
     ...
     ProNeW(config, config_c, train_spn_on_gt=False, train_spn_on_prediction=True, train_rnn_w_ll=False,
            always_detach=True),
